...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    correctedList = c, *missing_wagons,*d,  a , b

    return list(correctedList)
...
def extend_route_information(route, more_route_information):
    ...
    """
    combineDicts = {**route, **more_route_information}
    return combineDicts
...
def fix_wagon_depot(wagons_rows):
    ...
    """
    a, b, c = list(zip(*wagons_rows))
    newWagon = [list(a), list(b), list(c)]
    return newWagon
